                ...
                <?php if(is_logged_in()): ?>
                    <div class="relative group">
                        ...
                        <div class="dropdown-menu absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                            <a href="dashboard.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-50">
        ...
        <div class="md:hidden hidden bg-white py-3 px-4 shadow-lg" id="mobile-menu">
            ...
            <?php if(is_logged_in()): ?>
                <div class="border-t border-gray-200 mt-2 pt-2">
                    <a href="dashboard.php" class="block py-2 text-gray-700 hover:text-primary-600">
                        <i class="fas fa-tachometer-alt mr-2"></i> Tableau de bord
                    </a>
